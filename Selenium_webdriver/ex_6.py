...
with webdriver.Chrome() as browser:
    browser.get(url="https://parsinger.ru/selenium/5/5.html")

    checks = [i for i in browser.find_elements(By.CLASS_NAME, "check") if int(i.get_attribute("value")) in numbers]
    for item in checks:
        item.click()
